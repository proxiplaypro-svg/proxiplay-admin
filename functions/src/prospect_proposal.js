...
const RULES = [
  ...
  { sector: "sport", match: /\b(sport|sports|fitness|gym|gymnase|salle de sport|yoga|pilates)\b/, sentence: name => `L'idée pour ${name} pourrait être de faire gagner une séance, une formule découverte ou un bon cadeau afin de présenter votre activité aux utilisateurs locaux.` },
  ...
  { sector: "retail", match: /\b(commerce|commerces|boutique|magasin|store|shop|fleuriste|florist)\b/, sentence: name => `L'idée pour ${name} serait par exemple de faire gagner un produit ou un bon cadeau afin de faire découvrir votre boutique aux utilisateurs locaux.` },
];
