...
Les activités commerciales précises (bijouterie, opticien, librairie, épicerie, caviste, papeterie, chocolaterie, pâtisserie, boulangerie, animalerie, mercerie) utilisent également le texte boutique. Un magasin de sport, y compris le type Google `sporting_goods_store`, propose un produit ou bon cadeau, jamais une séance. Les salles d'escalade, centres de fitness et clubs sportifs conservent le texte séance/découverte. Cette distinction s'applique au même générateur individuel et groupé.
